...
module.exports = function (webpackEnv) {
  ...
  const configure = () => ({
    ...
    entry: [
      ...
      isEnvDevelopment &&
        'webpack-hot-middleware/client?reload=true&name=client&overlayWarnings=true',
    ...
    resolve: {
      ...
      alias: {
        // Use the modularized version of lodash
        lodash: 'lodash-es',
        // JSS uses is-in-browser but our bundle can be a tiny bit smaller if we substitute the
        // version from dom-helpers
        'is-in-browser': 'dom-helpers/util/inDOM',
      ...
      rules: [
        ...
        },
        {
          ...
          oneOf: [
                  ...
                  [
                    require.resolve('babel-plugin-named-asset-import'),
                    {
                      loaderMap: {
                        svg: {
                          ReactComponent:
                            '@svgr/webpack?prettier=true&ref=true&svgo=true![path]'
                        }
                      }
                    }
                  ]
            ...
            // symbol-based icon loader for svg
            {
              test: [/icons[\\/].+\.svg$/],
              issuer: /\.js$/,
              loader: 'svg-sprite-loader',
              options: {
                symbolId: 'symbol-[folder]-[name]'
              }
            },
    ...
    plugins: [
      ...
      // https://github.com/jmblog/how-to-optimpublicPathize-momentjs-with-webpack
