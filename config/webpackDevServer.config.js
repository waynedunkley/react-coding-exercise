...
const config = configFactory('development')[0]
...
module.exports = function (proxy, allowedHost) {
  return {
    ...
    before (app, server) {
      ...
      // we use sessions in src/server/middleware/favourites.js so we need to initialise express-session both here
      // and in scripts/server.prod.js
      app.use(session({
